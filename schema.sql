...
-- DTO Asset Inventory Table (from CSV)
CREATE TABLE IF NOT EXISTS dto_assets (
    ...
    bu_security_champion TEXT,
    xen_host_ip TEXT,
    xen_pool TEXT,
    xen_pool_uuid TEXT,
    hypervisor_owner TEXT,
    labstage_owner TEXT,
    mac_addresses TEXT,
    ip_mac_map TEXT,
