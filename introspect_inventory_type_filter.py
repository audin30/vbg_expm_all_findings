...
def get_wiz_token():
    ...
    # Using auth.app.wiz.io since it is standard
...
# Introspect CloudResourceV2Filters.type
query = """
query {
  __type(name: "CloudResourceV2Filters") {
    inputFields {
      name
      type {
        name
...
print(json.dumps(type_field, indent=2))
